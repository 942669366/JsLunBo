 ...
 */
!function(a){
	a.fn.extend({YuxiSlider:function(b){
					...
					if(p.style(),p.mobileDevice){
						...
						stop:function(){
							...
							description:function(){
								k.text(g+1),
								l.text(f),
								j.text(e.eq(g).find("img").attr("alt")).attr("href",
								e.eq(g).find("a").attr("href")).width(d.width-a("span.num",b).width()-20)},
								bindControl:function(){
									if(p.mobileDevice){
										if(d.control&&d.control.remove(),2>=f)
											return;
										c.get(0).addEventListener("touchstart",
										p.touchstart,
										!1
										),
										...
										c.get(0).addEventListener("touchend",p.touchend,!1)
											...
											b.hover(function(){
												...
												},function(){a(document).unbind(),d.auto&&p.auto()});
